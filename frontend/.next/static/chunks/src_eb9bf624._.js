...
function BarcodeScanner({ onScan }) {
    ...
    const readerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$browser$2f$esm$2f$readers$2f$BrowserMultiFormatReader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrowserMultiFormatReader"]());
    const streamRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BarcodeScanner.useEffect": ()=>{
            const reader = readerRef.current;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$browser$2f$esm$2f$readers$2f$BrowserMultiFormatReader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrowserMultiFormatReader"].listVideoInputDevices().then({
                "BarcodeScanner.useEffect": (devices)=>{
                    if (devices.length > 0 && videoRef.current) {
                        const deviceId = devices[0].deviceId;
                        reader.decodeFromVideoDevice(deviceId, videoRef.current, {
                            "BarcodeScanner.useEffect": (result, error, controls)=>{
                                if (result) {
                ...
                "BarcodeScanner.useEffect": (err)=>console.error(err)
            }["BarcodeScanner.useEffect"]);
            return ({
                "BarcodeScanner.useEffect": ()=>{
...
_s(BarcodeScanner, "6fk+aiDFbi8aIgEDMoHgsTQP9rA=");
_c = BarcodeScanner;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BarcodeScanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/BarcodeScanner.tsx [app-client] (ecmascript)"); // import scanner
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
_s(FilterControls, "Vs+8cpIVhYeVCpv3e9Ka9e1QFwM=");
_c = FilterControls;
var _c;
...
_s(DashboardPage, "uQrW+wh5O8WimCFuaUIASAwZdPI=", false, function() {
    return [
